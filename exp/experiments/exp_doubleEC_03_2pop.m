exp_id = 'exp_doubleEC_03_2pop';
exp_description = 'Surrogate CMA-ES model using double-trained EC with sd2 criterion and GPs with double population, and restrictedParam value 0.05; 5 and 10D -- for testing purposes with extended logging';
