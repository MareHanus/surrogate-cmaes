...
surrogateParams = { ...
  ...
  'DTAdaptive_updateRate',    { 0.25, 0.3, 0.35, 0.40, 0.45 }, ...
  'DTAdaptive_updateRateDown', { 0.3, 0.4, 0.5 }, ...
  'DTAdaptive_maxRatio',      { 1.0 }, ...
  'DTAdaptive_minRatio',      { 0.04 }, ...
  'DTAdaptive_lowErr',        { 0.075, 0.10, 0.125 }, ...
  'DTAdaptive_highErr',       { 0.35 }, ...
  'DTAdaptive_defaultErr',    { 0.20 }, ...
  'evoControlMaxDoubleTrainIterations', { 2 }, ...
  'evoControlPreSampleSize',       { 0.75 }, ...    % {0.25, 0.5, 0.75}, will be multip. by lambda
  'evoControlNBestPoints',         { 1 }, ...
  'evoControlValidationGenerationPeriod', { 3 }, ...
