exp_id = 'exp_doubleEC_19';
exp_description = 'Surrogate CMA-ES in 10D, adaptive DTS, UpdateRate={0.2:0.10:0.5}, updateRateDown={[0.5,1,1.5,2]*updateRate}, highErr={0.30,0.35,0.40}, lowErr={0.04,0.05}, DTIterations=2, PreSampleSize=0.75, sd2 criterion, 2pop';
...
surrogateParams = { ...
  ...
  'DTAdaptive_updateRate',    { 0.20, 0.30, 0.40, 0.50 }, ...
  ...
  'DTAdaptive_minRatio',      { 0.04, 0.05 }, ...         % 0.05 should be used only for 10D and 20D
