exp_id = 'exp_doubleEC_01_ei_poi_lcb';
exp_description = 'Surrogate CMA-ES model using double-trained EC with EI, PoI, and lcb criterion and GPs with default population and restrictedParam value 0.1; 2, 3, 5, 10D';
