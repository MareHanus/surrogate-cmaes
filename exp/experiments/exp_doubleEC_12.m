exp_id = 'exp_doubleEC_12';
exp_description = 'Surrogate CMA-ES, smooth/transfer adaptive DTS, UpdateRate={0.25,0.3,0.35,0.4}, updateRateDown={[],0.6,0.9}, highErr={0.35,0.40}, DTIterations={1,2}, PreSampleSize=0.75, sd2 criterion, 2pop';
...
surrogateParams = { ...
  ...
  'DTAdaptive_updateRate',    { 0.2, 0.3, 0.40 }, ...
  'DTAdaptive_updateRateDown', { 0.6, 0.9 }, ...
  'DTAdaptive_maxRatio',      { 1.0 }, ...
  'DTAdaptive_minRatio',      { 0.04 }, ...
  'DTAdaptive_lowErr',        { 0.15 }, ...
  'DTAdaptive_highErr',       { 0.35, 0.40 }, ...
