exp_id = 'exp_doubleEC_09';
exp_description = 'Surrogate CMA-ES, smooth/transfer adaptive DTS, UpdateRate={0.3,0.4,0.5,0.6,0.7}, highErr=0.40, DTIterations={1,2}, PreSampleSize=0.75, sd2 criterion, 2pop';
...
surrogateParams = { ...
  ...
  'DTAdaptive_updateRate',     { 0.3, 0.4, 0.5, 0.6, 0.7}, ...
