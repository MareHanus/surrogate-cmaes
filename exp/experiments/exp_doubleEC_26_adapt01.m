exp_id = 'exp_doubleEC_26_adapt01';
exp_description = 'Surrogate CMA-ES, adaptive DTS, DTIterations={1}, PreSampleSize=0.75, PoI criterion, 2pop';
...
surrogateParams = { ...
  ...
  'DTAdaptive_highErr',        { '@(x) [ones(size(x,1),1) x(:,1) x(:,2) x(:,1).*x(:,2) x(:,2).^2] * [0.18; -0.0027; 0.44; 0.0032; -0.14]' }, ...
