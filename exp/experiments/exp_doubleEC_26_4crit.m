exp_id = 'exp_doubleEC_26_4crit';
exp_description = 'DTS-CMA-ES with f-values, sd2, EI and meRDE criterion, best dataset-generation types from offline model testing and ANOVA assessment, in [2,3,5,10,20]D, Surrogate CMA-ES, fixed DTS 0.05 (merged code), DTIterations={1}, PreSampleSize=0.75, 2pop';
...
modelParams = { ...
  ...
  'predictionType',     { 'fvalues', 'sd2', 'ei', 'expectedRank' }, ...
  'useShift',           { false }, ...
  'normalizeY',         { true }, ...
