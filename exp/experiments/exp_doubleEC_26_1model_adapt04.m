exp_id = 'exp_doubleEC_26_1model_adapt04';
exp_description = 'Surrogate CMA-ES, adaptive DTS, 1 model for all dimensions: best dataset-generation type from offline model testing and ANOVA assessment, lowErr=LOW, highErr=HIGH, updateRate=0.3, updateRateDown=updateRate, DTIterations={1}, PreSampleSize=0.75, PoI criterion, 2pop';
