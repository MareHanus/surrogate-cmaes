exp_id = 'exp_doubleEC_01_fvalues_20D';
exp_description = 'Surrogate CMA-ES model using double-trained EC with `fvalues` criterion and GPs with default population, and restrictedParam value 0.1; 20D';
