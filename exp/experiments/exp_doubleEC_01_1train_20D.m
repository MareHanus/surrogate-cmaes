exp_id = 'exp_doubleEC_01_1train_20D';
exp_description = 'Surrogate CMA-ES model using double-trained EC without the second training, with `sd2` criterion and GPs with default population, and restrictedParam value 0.1; 20D';
