exp_id = 'exp_doubleEC_20';
exp_description = 'Surrogate CMA-ES, fixed DTS 0.05 (adaptive code) for logging purposes, UpdateRate={0.3}, DTIterations={1}, PreSampleSize=0.75, {sd2,expectedRank,fvalues} criterion, 2pop';
