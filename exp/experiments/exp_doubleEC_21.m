exp_id = 'exp_doubleEC_21';
exp_description = 'Surrogate CMA-ES, fixed DTS 0.05 (adaptive code) with expectedRank, UpdateRate={0.3}, DTIterations={1}, PreSampleSize=0.75, {sd2,expectedRank,fvalues} criterion, 1pop and 2pop';
