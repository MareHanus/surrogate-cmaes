exp_id = 'exp_doubleEC_01_1train';
exp_description = 'Surrogate CMA-ES model using double-trained EC without the second training, with `sd2` criterion and GPs with default population, and restrictedParam value 0.1; 2D, 3D, 5D, 10D';
...
surrogateParams = { ...
  ...
  'evoControlUseDoubleTraining', { false }, ...      % whether use second/double train
